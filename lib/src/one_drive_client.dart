...
class OneDriveClient {
  ...
  late final Dio _client = Dio(
      BaseOptions(baseUrl: "https://api.onedrive.com/v1.0/"))
    ..interceptors.addAll([
  ...
  Future<List<Item>> getItems(String itemId, {CancelToken? cancelToken}) async {
    var response = await _client.get("/drive/items/$itemId/children",
  ...
  Future download(String itemId, String savePath,
    ...
    return _client.download("/drive/items/$itemId/content", savePath,
